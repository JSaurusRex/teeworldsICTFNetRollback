...
void CCharacter::TickDefered()
{
	// advance the dummy
	{
		...
		m_ReckoningCore.Tick(false, GameServer()->playerHistory);
...
{
	if(NetworkClipped(SnappingClient, m_Pos + vec2(m_pPlayer->m_Latency.m_Avg,m_pPlayer->m_Latency.m_Avg) * m_Core.m_Vel))
		return;
